...
int CXFileUtil::XFileLoad(LPDIRECT3DDEVICE9 pD3DDevice, char *xFileName, float r, float g, float b)
{
    ...
    for( DWORD i=0; i<g_dwNumMaterials; i++ )
    {
		...
		//// 재질 색상 변경
		g_pMeshMaterials[i].Diffuse.r = r;
		g_pMeshMaterials[i].Diffuse.g = g;
		g_pMeshMaterials[i].Diffuse.b = b;
